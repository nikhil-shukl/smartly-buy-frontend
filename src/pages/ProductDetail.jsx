    ...
    <>
      ...
      <Helmet>
        ...
        <meta
          name="description"
          content={
            product.verdict?.substring(0, 160) + "..."
          }
        />
        <meta
          name="keywords"
          content={`Best ${product.name}, ${product.category}, ${product.pros?.join(', ')}`}
        />
        <link
          rel="canonical"
          href={`https://www.techtrendydeals.com/product/${product.slug}`}
        />
      ...
      <div className="max-w-4xl mx-auto p-10 relative">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-2 text-indigo-700 border-l-4 border-indigo-500 pl-3">
            Description
          </h2>
        ...
        {/* Pros */}
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-2 text-green-600 border-l-4 border-green-500 pl-3">
            Pros
          </h2>
        ...
        {/* Cons */}
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-2 text-red-600 border-l-4 border-red-500 pl-3">
            Cons
          </h2>
        ...
        {/* Verdict */}
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-2 text-gray-900 border-l-4 border-gray-700 pl-3">
            Verdict
          </h2>
